        ...
        <div class="serviceBox" style="height: 400px;">
            <h3 class="title">Ichaapurti Night</h3> 
                <?php if(empty($tsoftId) && $patiid =='open'){ ?>
                 ...
                 <div class="col-md-4" style="padding-top: 20px;"><a href="ichaapurti-night-single.php?msg=open"><img src="assets\dist\img\single_akata.png"> </a></div>
                 <div class="col-md-4"  style="padding-top: 20px;"><a href="ichaapurti-night-jodi.php?msg=open"><img src="assets\dist\img\jodi.png"></a></div>
                 <div class="col-md-4"  style="padding-top: 20px;">><a href="ichaapurti-night-pati.php?msg=open"><img src="assets\dist\img\patti.png"></a></div>
                 <?php } ?>
                ...
                <div class="col-md-6" style="padding-top: 20px;"><a href="ichaapurti-night-single.php?msg=close"><img src="assets\dist\img\single_akata.png"> </a></div>
                <div class="col-md-6"  style="padding-top: 20px;">><a href="ichaapurti-night-patti.php?msg=close"><img src="assets\dist\img\patti.png"></a></div>
                <?php } ?>
        </div>
    </div>    
</div>
