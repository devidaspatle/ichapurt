          ...
          <div class="card-body">
            ...
            <form method="POST" action="classess/single_akata_code.php">
             ...
             <div class="col-md-12" style="padding: 20px;">
                <input type="hidden" name="category_name" value="ichaapurti-night-single" class="form-control" />
                 ...
                 <table style="width:100%">
                  <tr style="color: black">
                    ...
                    <td  style="text-align: right;">  <a href="ichaapurti_night.php"> <button type="button" class="btn btn-success btn-lg mb-1">Back</button></a></td>
                  </tr>
                    <tr style="color: black">
