...
$crud = new Etstysem();
$query11 = "SELECT * FROM tbl_jodi_chart WHERE  mattka_type ='RAJNIG9877' order by id asc";
...
<div class="panel-heading text-center" style="background: #3f51b5;"><h1 style="font-size: 22px;color:#fff; text-shadow: 0px 0px;">RAJDHANI NIGHT CHART</h1></div>
<div class="panel-body">
