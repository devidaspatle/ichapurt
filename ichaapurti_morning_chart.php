...
$crud = new Etstysem();
$query11 = "SELECT * FROM tbl_jodi_chart WHERE  mattka_type ='ICHMOR9876'  order by id asc";
...
<div class="panel-heading text-center" style="background: #3f51b5;"><h1 style="font-size: 22px;color:#fff; text-shadow: 0px 0px;">ICHAAPURTI MORNING JODI CHART</h1></div>
<div class="panel-body">
<table style="width: 100%; text-align:center;" cellpadding="2" >
<thead> 
<tr>
<th>#</th>
...
<th style="font-size:20px;">Sat</th>
</tr>
</thead>
<tbody>
<?php    
...
?>
  <tr>
    ...
    <td style="font-size:20px;"><?php echo 	$row11['satus'];?></td>
  </tr>
 <?php } ?>
</tbody>
</table>
