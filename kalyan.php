       ...
       <div class="col-md-10" >
        <div class="serviceBox" style="height: 400px;">
            <h3 class="title">kalyan</h3> 
                ...
                <div class="col-md-4" style="padding-top: 20px;"><a href="kalyan-single.php?msg=open"><img src="assets\dist\img\single_akata.png"> </a></div>
                <div class="col-md-4"  style="padding-top: 20px;"><a href="kalyan-jodi.php?msg=open"><img src="assets\dist\img\jodi.png"></a></div>
                <div class="col-md-4"  style="padding-top: 20px;">><a href="kalyan-pati.php?msg=open"><img src="assets\dist\img\patti.png"></a></div>
                <?php } ?>
                ...
                <div class="col-md-6" style="padding-top: 20px;"><a href="kalyan-single.php?msg=close"><img src="assets\dist\img\single_akata.png"> </a></div>
                <div class="col-md-6"  style="padding-top: 20px;">><a href="kalyan-pati.php?msg=close"><img src="assets\dist\img\patti.png"></a></div>
                <?php } ?>
        </div>
    </div>    
</div>
