...
use App\Http\Controllers\SingleakataController;
use App\Http\Controllers\JodiController;
use App\Http\Controllers\PattiController;
use App\Http\Controllers\ReportjodiController;
...
Route::resource('/pattis', 'PattiController');
Route::resource('/jodis', 'JodiController');
Route::resource('/singleakatas', 'SingleakataController');

Route::get('/export_jodi_file','JodiController@get_jodi_data');
Route::get('/export_single_file','SingleakataController@get_single_data');
Route::get('/export_patti_file','PattiController@get_patti_data');

Route::resource('/reportjodis', 'ReportjodiController');
Route::resource('/reportpattis', 'ReportpattiController');
Route::resource('/reportsingles', 'ReportsingleController');

//Route::get('customers', 'CustomerController@filterByProperty')->name('customers.index');
Route::get('reportjodis', 'ReportjodiController@filterByJodi')->name('reportjodis.index');
Route::post('reportsingles', 'ReportsingleController@filterByProperty')->name('reportsingles.index');
Route::get('reportpattis', 'ReportpattiController@filterByProperty')->name('reportpattis.index');
