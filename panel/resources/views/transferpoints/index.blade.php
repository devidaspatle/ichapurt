        ...
        <div class="content-wrapper">
            <section class="content-header">
                ...
                <ol class="breadcrumb">
                    ...
                    <li class="active"> Transfer Points</li>
...
<div class="box">
    ...
    <div class="box-body">
        <div class="mt-4 mb-4">
           <form action="{{ route('transferpoints.store') }}" method="POST">
                    {{ csrf_field() }}
                    <input type="hidden" id="currentStatus" name="currentStatus" value="Paid" class="form-control">
                        ...
                        <label for="title" class="col-sm-2 col-form-label">Select Customer Name</label>
                            ...
                            <div class="col-sm-2">
                            <input type="text" id="pay_point" name="pay_point" value="" class="form-control">
                            </div>
           ...
           <tfoot>
                ...
                <?php $i =1; ?>
                    ...
                    <tr>
                        ...
                        <td style="width:8%"><div style="float:left"><a href="{{ route('transferpoints.edit',$row->id)}}" onclick="return confirm('Are you sure to Pay?')"><i class="fa fa-edit" style="font-size:22px"></i></a> </div>&nbsp; 
