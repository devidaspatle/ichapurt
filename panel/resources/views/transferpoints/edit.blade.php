...
<div class="box">
    ...
    <div class="box-body">
         ...
         <form method="post" action="{{ route('transferpoints.update', $transferpoints->id) }}" enctype="multipart/form-data">
        @method('PATCH')
        @csrf
        <div class="row  justify-content-start align-items-start">
            <div class="col-md-6 form-group">
                ...
                <select id="customerId" class="form-control" name="customerId" required="required">
                            ...
                            <option value="{{$customer->name}}"{{ ( $customer->name == $transferpoints->customerId ) ? 'selected' : 'selected' }}>{{$customer->name}}</option>
                            @endforeach
                </select>
            </div>
            ...
            <div class="col-md-4 form-group">
                ...
                <input type="text" id="pay_point" name="pay_point" value="{{$transferpoints->pay_point}}" class="form-control">   
            </div>
