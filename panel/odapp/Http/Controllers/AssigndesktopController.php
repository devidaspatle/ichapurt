...
class AssigndesktopController extends Controller
{
    public function index()
    {
        $desktops = Desktop::where('status','Y')->get();
        return view('assigndesktops.index',compact('desktops'));
    }
    ...
    {   
         ...
         $assignprot = 1;
         return view('assigndesktops.create',compact('assignprot','productids','products','locations','campus','monitors','keyboards','mouses','departments','offices','vendors','makes','models','rams','screens','slots','hdds','processors'));
        }
    ...
    public function update(Request $request, $id)
    {
        ...
        { 
         ...
         $products = Product::where('productId',$val)->update(["asset_code" => $product->asset_code, "location" => $product->location,"campus" => $product->campus,"office" => $product->office,"department" => $input['department'],
          "employee" => $input['employee'],"employeeid" => $input['employeeid'],"asset_type" => 'Desktop', "serial_number" => $serial_number,"monitor_code" => $input['monitor_code'],"keyboard_code" => $input['keyboard_code'],
...
//die;
        ...
        return redirect()->route('assigndesktops.index')->with('message','College  has been updated successfully.');
    }
