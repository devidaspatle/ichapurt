       ...
       <div class="col-md-10" >
        <div class="serviceBox" style="height: 400px;">
            ...
            <div class="col-md-4"  style="padding-top: 20px;">><a href="" onclick="return confirm('Please Login before.')"><img src="assets\dist\img\patti.png"></a></div>
             ...
             <div class="col-md-4" style="padding-top: 20px;"><a href="rajdhani-night-single.php?msg=open"><img src="assets\dist\img\single_akata.png"> </a></div>
            <div class="col-md-4"  style="padding-top: 20px;"><a href="rajdhani-night-jodi.php?msg=open"><img src="assets\dist\img\jodi.png"></a></div>
            <div class="col-md-4"  style="padding-top: 20px;">><a href="rajdhani-night-pati.php?msg=open"><img src="assets\dist\img\patti.png"></a></div>
             <?php } ?>
            ...
            <div class="col-md-6" style="padding-top: 20px;"><a href="rajdhani-night-single.php?msg=close"><img src="assets\dist\img\single_akata.png"> </a></div>
            <div class="col-md-6"  style="padding-top: 20px;">><a href="rajdhani-night-pati.php?msg=close"><img src="assets\dist\img\patti.png"></a></div>
            <?php } ?>
        </div>
    </div>    
</div>
