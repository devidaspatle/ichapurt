       ...
       <div class="col-md-10" >
        <div class="serviceBox" style="height: 400px;">
            <h3 class="title">Prabhat</h3> 
                ...
                <div class="col-md-4" style="padding-top: 20px;"><a href="prabhat-single.php?msg=open"><img src="assets\dist\img\single_akata.png"> </a></div>
                <div class="col-md-4"  style="padding-top: 20px;"><a href="prabhat-jodi.php?msg=open"><img src="assets\dist\img\jodi.png"></a></div>
                <div class="col-md-4"  style="padding-top: 20px;">><a href="prabhat-pati.php?msg=open"><img src="assets\dist\img\patti.png"></a></div>
                <?php } ?>
                <?php if(empty($tsoftId) && $patiid =='close'){ ?>
                 ...
                 <div class="col-md-6" style="padding-top: 20px;"><a href="prabhat-single.php?msg=close"><img src="assets\dist\img\single_akata.png"> </a></div>
                 <div class="col-md-6"  style="padding-top: 20px;">><a href="prabhat-pati.php?msg=close"><img src="assets\dist\img\patti.png"></a></div>
                 <?php } ?>
