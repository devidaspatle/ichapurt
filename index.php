...
$opentime = date_format($date, 'H:i');
$closetime = date("H:i", strtotime($catoutTime11));
$created_ats  =  $created_atim;
$date =  date("Y/m/d");
?>
...
<div style="float: right;"><a href="index.php"><button class="btn btn-success">Refersh </button> </a></div>
</div>
            <!-- Main content -->
...
<div class="row service-div">
       <div class="col-md-4">
        <div class="serviceBox">
          ...
          <?php  $opentimeop11 = $inopentime11 - '2:00';
           $inclosetimess11 = $inclosetime11 - '2:00'; 
            if($opentime<=$opentimeop11) { echo "XXX X"; } else {?>
            ...
            <div class="service-icon">
             ...
             $inclosetimess11 = $inclosetime11 - '1:30';
       ...
       <div class="col-md-4">
        <div class="serviceBox">
            ...
            if($opentime<=$opentimeop12) { echo "XXX X"; } else {?>  
                 <?php echo $double_pati12; ?>&nbsp;<?php echo $single_akata12; }?><?php if(!empty($double_paticls12)){ ?><?php echo $single_akatacls12; ?>&nbsp;<?php echo $double_paticls12; ?>
            <?php } else { ?>X &nbsp;XXX<?php } ?>
            </h3>
        ...
        <div class="serviceBox">
            ...
            if($opentime<=$opentimeop13) { echo "XXX X"; } else {?>      
                <?php echo $double_pati13; ?>&nbsp;<?php echo $single_akata13; }?><?php if(!empty($double_paticls13)){ ?><?php echo $single_akatacls13; ?>&nbsp;<?php echo $double_paticls13; ?>
            <?php } else { ?>X &nbsp;XXX<?php } ?>
            </h3>
      ...
      <div class="col-md-4">
        <div class="serviceBox">
            <h3 class="title">Kalyan</h3>  
              ...
              <h3 class="box-count" style="text-align: center;">
            <?php 
            $opentimeop14 = $inopentime14 - '2:00';
            if($opentime<=$opentimeop14) { echo "XXX X"; } else {?>      
            <?php echo $double_pati14; ?>&nbsp;<?php echo $single_akata14; } ?><?php if(!empty($double_paticls14)){ ?><?php echo $single_akatacls14; ?>&nbsp;<?php echo $double_paticls14; ?>
            <?php } else { ?>X &nbsp;XXX<?php } ?>
            </h3>
       ...
       <div class="col-md-4">
        <div class="serviceBox">
            ...
            ?>  
              ...
              <h3 class="box-count"><?php if($opentime<=$opentimeop15) { echo "XXX X"; } else {?> <?php echo $double_pati15; ?>&nbsp; <?php echo  $single_akata15;} ?>
              
              <?php if(!empty($double_paticls15)){ ?><?php echo $single_akatacls15; ?>&nbsp;<?php echo $double_paticls15; ?>
            <?php } else { ?>X &nbsp;XXX<?php } ?>
            </h3>
      ...
      <div class="col-md-4">
        <div class="serviceBox">
            ...
            <h3 class="box-count"><?php 
             $opentimeop16 = $inopentime16 - '2:00';
            if($opentime<=$opentimeop16) { echo "XXX X"; } else {?><?php echo $double_pati16; ?>&nbsp;<?php echo $single_akata16; } ?><?php if(!empty($double_paticls16)){ ?><?php echo $single_akatacls16; ?>&nbsp;<?php echo $double_paticls16; ?>
            <?php } else { ?>X &nbsp;XXX<?php } ?>
            </h3>
        ...
        <div class="serviceBox">
           ...
           <h3 class="box-count">
           <?php   $opentimeop17 = $inopentime17 - '2:00';
            if($opentime<=$opentimeop16) { echo "XXX X"; } else {?><?php echo $double_pati17; ?>&nbsp;<?php echo $single_akata17; }?><?php if(!empty($double_paticls17)){ ?><?php echo $single_akatacls17; ?>&nbsp;<?php echo $double_paticls17; ?>
            <?php } else { ?>X &nbsp;XXX<?php } ?>
            </h3>
            <div class="service-icon">
            ...
            <?php
               $opentimeop17 = $inopentime17 - '2:00';
