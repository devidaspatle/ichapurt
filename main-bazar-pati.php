          ...
          <div class="card-body">
            ...
            <form method="post" action="classess/patti_code.php">
             ...
             <div class="row">
              ...
              <input type="hidden" name="category_name" value="main_bazar_patti" class="form-control" />
                 ...
                 <table style="width:100%">
                  <tr style="color: black">
                    <td colspan="4" style="text-align: center;"><h3>Enter Patti Data</h3></td>
                     <td  style="text-align: right;">  <a href="main_bazar.php?msg=open"> <button type="button" class="btn btn-success btn-lg mb-1">Back</button></a></td>
                  </tr>
